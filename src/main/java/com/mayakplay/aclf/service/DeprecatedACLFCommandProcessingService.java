...
//            return new ConsoleCommandResponse((ConsoleCommandSender) sender, definition.getControllerName(), definition.getSubCommandName(), argumentsMessage);
//        if (definition.hasPlayerOnlyFlag())
//            return new PlayerCommandResponse((Player) sender, definition.getControllerName(), definition.getSubCommandName(), argumentsMessage);
//      //else
//            return new CommandResponse(sender, definition.getControllerName(), definition.getSubCommandName(), argumentsMessage);
//    }
//
//    //endregion
//
